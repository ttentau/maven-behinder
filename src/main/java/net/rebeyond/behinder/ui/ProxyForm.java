...
public class ProxyForm extends Shell {
    ...
    private void enableControls(boolean enable) {
        Control[] var5;
        int var4 = (var5 = this.proxyComp.getChildren()).length;
    ...
    private void showError(String errorTxt) {
        MessageBox dialog = new MessageBox(this.getShell(), 33);
        dialog.setText("保存失败");
    ...
    public ProxyForm(Display display, final Label ProxyStatusLabel) {
        ...
        this.setLayout(new FillLayout(256));
        ...
        saveProxyBtn.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent arg0) {
                try {
                    ...
                    ProxyForm.this.showError(var11.getMessage());
                }
    ...
    protected void createContents() {
        this.setText("代理服务器设置");
        this.setSize(456, 285);
    }
